...
use Aliyun\Auth\Credential;
use Aliyun\Auth\ISigner;
use Aliyun\Auth\ShaHmac1Signer;
use Aliyun\Auth\ShaHmac256Signer;

use Aliyun\Exception\ClientException;
use Aliyun\Exception\ServerException;

//use Aliyun\Profile\DefaultProfile;
//use Aliyun\Profile\IClientProfile;

use Aliyun\Regions\EndpointProvider;
use Aliyun\Regions\Endpoint;
use Aliyun\Regions\ProductDomain;
